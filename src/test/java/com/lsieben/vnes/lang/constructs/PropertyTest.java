...
class PropertyTest {
    ...
    void propertyAssignment() {
        ...
        Property property = new PropertyAssignmentVisitor().visitPropertyAssignment(parser.propertyAssignment());
        assertNotNull(property, "Property assignment was not recognized by parser.");
        assertEquals(property.getIdentifierName(), "test", "Property does not have test as name.");
    ...
    void propertyDefinition() {
        ...
        Property property = new PropertyDefinitionVisitor().visitPropertyDefinition(parser.propertyDefinition());
